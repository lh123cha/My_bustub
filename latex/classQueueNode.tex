...
\begin{center}
\leavevmode
\includegraphics[width=182pt]{classQueueNode__coll__graph}
\end{center}
\end{figure}
...
\item 
build/googletest-\/src/googletest/samples/\mbox{\hyperlink{sample3-inl_8h}{sample3-\/inl.\+h}}\end{DoxyCompactItemize}
