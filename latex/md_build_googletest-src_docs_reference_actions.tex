...
\end{longtabu}
\hypertarget{md_build_googletest-src_docs_reference_actions_autotoc_md245}{}\doxysection{Side Effects}\label{md_build_googletest-src_docs_reference_actions_autotoc_md245}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build_googletest-src_docs_reference_actions_autotoc_md246}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_build_googletest-src_docs_reference_actions_autotoc_md246}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_build_googletest-src_docs_reference_actions_autotoc_md247}{}\doxysection{Default Action}\label{md_build_googletest-src_docs_reference_actions_autotoc_md247}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{namespacetesting_ae041df61ff61ccb9753ba15b4309e1a6}{Do\+Default()}}} &Do the default action (specified by {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{O\+N\+\_\+\+C\+A\+L\+L()}}} or the built-\/in one).  \\\cline{1-2}
\end{longtabu}


\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily \mbox{\hyperlink{namespacetesting_ae041df61ff61ccb9753ba15b4309e1a6}{Do\+Default()}}} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_build_googletest-src_docs_reference_actions_autotoc_md248}{}\doxysection{Composite Actions}\label{md_build_googletest-src_docs_reference_actions_autotoc_md248}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build_googletest-src_docs_reference_actions_autotoc_md249}{}\doxysection{Defining Actions}\label{md_build_googletest-src_docs_reference_actions_autotoc_md249}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\cellcolor{\tableheadbgcolor}\textbf{ Macro }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{gmock-actions_8h_a7af7137aa4871df4235881af377205fe}{A\+C\+T\+I\+O\+N(\+Sum)}} \{ return arg0 + arg1; \}} &Defines an action {\ttfamily Sum()} to return the sum of the mock function\textquotesingle{}s argument \#0 and \#1.  \\\cline{1-2}
{\ttfamily \mbox{\hyperlink{gmock-actions_8h_af5f47e069acb517db9f743f029471aa7}{A\+C\+T\+I\+O\+N\+\_\+\+P(\+Plus, n)}} \{ return arg0 + n; \}} &Defines an action {\ttfamily Plus(n)} to return the sum of the mock function\textquotesingle{}s argument \#0 and {\ttfamily n}.  \\\cline{1-2}
