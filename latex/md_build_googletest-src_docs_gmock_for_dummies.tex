\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md200}{}\doxysection{What Is g\+Mock?}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md200}
...
\end{DoxyEnumerate}\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md201}{}\doxysection{Why g\+Mock?}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md201}
...
\end{DoxyItemize}\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md202}{}\doxysection{Getting Started}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md202}
g\+Mock is bundled with googletest.\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md203}{}\doxysection{A Case for Mock Turtles}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md203}
...
\item In the {\ttfamily public\+:} section of the child class, write {\ttfamily \mbox{\hyperlink{gmock-function-mocker_8h_a05ffc29d0784b131ee178da190d31397}{M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+O\+D()}};}
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md206}{}\doxysubsection{Where to Put It}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md206}
...
{\bfseries{Important note\+:}} g\+Mock requires expectations to be set {\bfseries{before}} the mock functions are called, otherwise the behavior is {\bfseries{undefined}}. Do not alternate between calls to {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} and calls to the mock functions, and do not set any expectations on a mock after passing the mock to an A\+PI.

This means {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} should be read as expecting that a call will occur {\itshape in the future}, not that a call has occurred. Why does g\+Mock work like that? Well, specifying the expectation beforehand allows g\+Mock to report a violation as soon as it rises, when the context (stack trace, etc) is still available. This makes debugging much easier.

Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using g\+Mock. However, as we shall reveal soon, g\+Mock allows you to do {\itshape so much more} with the mocks.\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md208}{}\doxysection{Setting Expectations}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md208}
...
right.\char`\"{}\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md209}{}\doxysubsection{General Syntax}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md209}
In g\+Mock we use the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} macro to set an expectation on a mock method. The general syntax is\+:
...
\DoxyCodeLine{    .WillOnce(\mbox{\hyperlink{namespacerun__clang__format_a1f8360d092b523047e2131d8317ad584}{action}})}
\DoxyCodeLine{    .WillRepeatedly(\mbox{\hyperlink{namespacerun__clang__format_a1f8360d092b523047e2131d8317ad584}{action}});}
\end{DoxyCode}
...
{\ttfamily \+\_\+} is an instance of what we call {\bfseries{matchers}}. A matcher is like a predicate and can test whether an argument is what we\textquotesingle{}d expect. You can use a matcher inside {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} wherever a function argument is expected. {\ttfamily \+\_\+} is a convenient way of saying \char`\"{}any value\char`\"{}.

In the above examples, {\ttfamily 100} and {\ttfamily 50} are also matchers; implicitly, they are the same as {\ttfamily Eq(100)} and {\ttfamily Eq(50)}, which specify that the argument must be equal (using {\ttfamily operator==}) to the matcher argument. There are many \mbox{\hyperlink{matchers_8md}{built-\/in matchers}} for common types (as well as \href{gmock_cook_book.md\#NewMatchers}{\texttt{ custom matchers}}); for example\+:
...
This works for all non-\/overloaded methods; if a method is overloaded, you need to help g\+Mock resolve which overload is expected by specifying the number of arguments and possibly also the \href{gmock_cook_book.md\#SelectOverload}{\texttt{ types of the arguments}}.\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md211}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md211}
...
{\bfseries{Quick quiz\+:}} what do you think will happen if a function is expected to be called twice but actually called four times?\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md212}{}\doxysubsection{Actions\+: What Should It Do?}\label{md_build_googletest-src_docs_gmock_for_dummies_autotoc_md212}
...
Instead of returning 100, 101, 102, ..., consecutively, this mock function will always return 100 as {\ttfamily n++} is only evaluated once. Similarly, {\ttfamily Return(new Foo)} will create a new {\ttfamily Foo} object when the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} is executed, and will return the same pointer every time. If you want the side effect to happen every time, you need to define a custom action, which we\textquotesingle{}ll teach in the \mbox{\hyperlink{gmock__cook__book_8md}{cook book}}.
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! The details can be found \href{gmock_cook_book.md\#OrderedCalls}{\texttt{ here}}.)\hypertarget{md_build_googletest-src_docs_gmock_for_dummies_StickyExpectations}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_build_googletest-src_docs_gmock_for_dummies_StickyExpectations}
