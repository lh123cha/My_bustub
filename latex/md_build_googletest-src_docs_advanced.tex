\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md11}{}\doxysection{Introduction}\label{md_build_googletest-src_docs_advanced_autotoc_md11}
Now that you have read the \mbox{\hyperlink{primer_8md}{googletest Primer}} and learned how to write tests using googletest, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md12}{}\doxysection{More Assertions}\label{md_build_googletest-src_docs_advanced_autotoc_md12}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md13}{}\doxysubsection{Explicit Success and Failure}\label{md_build_googletest-src_docs_advanced_autotoc_md13}
See \href{reference/assertions.md\#success-failure}{\texttt{ Explicit Success and Failure}} in the Assertions Reference.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md14}{}\doxysubsection{Exception Assertions}\label{md_build_googletest-src_docs_advanced_autotoc_md14}
See \href{reference/assertions.md\#exceptions}{\texttt{ Exception Assertions}} in the Assertions Reference.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md15}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_build_googletest-src_docs_advanced_autotoc_md15}
...
googletest gives you three different options to solve this problem\+:\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md16}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build_googletest-src_docs_advanced_autotoc_md16}
If you already have a function or functor that returns {\ttfamily bool} (or a type that can be implicitly converted to {\ttfamily bool}), you can use it in a {\itshape predicate assertion} to get the function arguments printed for free. See \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D$\ast$}}} in the Assertions Reference for details.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md17}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_build_googletest-src_docs_advanced_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md18}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_build_googletest-src_docs_advanced_autotoc_md18}
If you find the default message generated by \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D$\ast$}}} and \href{reference/assertions.md\#EXPECT_TRUE}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+R\+UE}}} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted. See \href{reference/assertions.md\#EXPECT_PRED_FORMAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D\+\_\+\+F\+O\+R\+M\+A\+T$\ast$}}} in the Assertions Reference for details.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md19}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_build_googletest-src_docs_advanced_autotoc_md19}
See \href{reference/assertions.md\#floating-point}{\texttt{ Floating-\/\+Point Comparison}} in the Assertions Reference.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md20}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_build_googletest-src_docs_advanced_autotoc_md20}
...
The above code verifies that {\ttfamily val1} is less than, or approximately equal to, {\ttfamily val2}.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md21}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_build_googletest-src_docs_advanced_autotoc_md21}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+AT}}} in the Assertions Reference.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md22}{}\doxysubsection{More String Assertions}\label{md_build_googletest-src_docs_advanced_autotoc_md22}
...
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md23}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_build_googletest-src_docs_advanced_autotoc_md23}
See \href{reference/assertions.md\#HRESULT}{\texttt{ Windows H\+R\+E\+S\+U\+LT Assertions}} in the Assertions Reference.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md24}{}\doxysubsection{Type Assertions}\label{md_build_googletest-src_docs_advanced_autotoc_md24}
...
to cause a compiler error.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md25}{}\doxysubsection{Assertion Placement}\label{md_build_googletest-src_docs_advanced_autotoc_md25}
...
\{\+: .callout .warning\} W\+A\+R\+N\+I\+NG\+: A fatal assertion in a helper function (private void-\/returning method) called from a constructor or destructor does not terminate the current test, as your intuition might suggest\+: it merely returns from the constructor or destructor early, possibly leaving your object in a partially-\/constructed or partially-\/destructed state! You almost certainly want to {\ttfamily abort} or use {\ttfamily Set\+Up}/{\ttfamily Tear\+Down} instead.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md26}{}\doxysection{Skipping test execution}\label{md_build_googletest-src_docs_advanced_autotoc_md26}
Related to the assertions {\ttfamily \mbox{\hyperlink{gtest_8h_a75adcdf89f69b0b615e395daafc315af}{S\+U\+C\+C\+E\+E\+D()}}} and {\ttfamily \mbox{\hyperlink{gtest_8h_a3e26a8d27caa386ed0ea7ce9d5b7c4ed}{F\+A\+I\+L()}}}, you can prevent further test execution at runtime with the {\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}}} macro. This is useful when you need to check for preconditions of the system under test during runtime and skip tests in a meaningful way.

{\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}}} can be used in individual test cases or in the {\ttfamily Set\+Up()} methods of classes derived from either {\ttfamily \mbox{\hyperlink{classtesting_1_1Environment}{testing\+::\+Environment}}} or {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}}. For example\+:
...
As with assertion macros, you can stream a custom message into {\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}}}.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md27}{}\doxysection{Teaching googletest How to Print Your Values}\label{md_build_googletest-src_docs_advanced_autotoc_md27}
...
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md28}{}\doxysection{Death Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md28}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md29}{}\doxysubsection{How to Write a Death Test}\label{md_build_googletest-src_docs_advanced_autotoc_md29}
...
In particular, if {\ttfamily statement} generates an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$} or {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as googletest assertions don\textquotesingle{}t abort the process.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md30}{}\doxysubsection{Death Test Naming}\label{md_build_googletest-src_docs_advanced_autotoc_md30}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md31}{}\doxysubsection{Regular Expression Syntax}\label{md_build_googletest-src_docs_advanced_autotoc_md31}
When built with Bazel and using Abseil, googletest uses the \href{https://github.com/google/re2/wiki/Syntax}{\texttt{ R\+E2}} syntax. Otherwise, for P\+O\+S\+IX systems (Linux, Cygwin, Mac), googletest uses the \href{http://www.opengroup.org/onlinepubs/009695399/basedefs/xbd_chap09.html\#tag_09_04}{\texttt{ P\+O\+S\+IX extended regular expression}} syntax. To learn about P\+O\+S\+IX syntax, you may want to read this \href{http://en.wikipedia.org/wiki/Regular_expression\#POSIX_Extended_Regular_Expressions}{\texttt{ Wikipedia entry}}.
...
To help you determine which capability is available on your system, googletest defines macros to govern which regular expression it is using. The macros are\+: {\ttfamily G\+T\+E\+S\+T\+\_\+\+U\+S\+E\+S\+\_\+\+S\+I\+M\+P\+L\+E\+\_\+\+RE=1} or {\ttfamily G\+T\+E\+S\+T\+\_\+\+U\+S\+E\+S\+\_\+\+P\+O\+S\+I\+X\+\_\+\+RE=1}. If you want your death tests to work in all cases, you can either {\ttfamily \#if} on these macros or use the more limited syntax only.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md32}{}\doxysubsection{How It Works}\label{md_build_googletest-src_docs_advanced_autotoc_md32}
See \href{reference/assertions.md\#death}{\texttt{ Death Assertions}} in the Assertions Reference.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md33}{}\doxysubsection{Death Tests And Threads}\label{md_build_googletest-src_docs_advanced_autotoc_md33}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md34}{}\doxysubsection{Death Test Styles}\label{md_build_googletest-src_docs_advanced_autotoc_md34}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md35}{}\doxysubsection{Caveats}\label{md_build_googletest-src_docs_advanced_autotoc_md35}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md36}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_build_googletest-src_docs_advanced_autotoc_md36}
\{\+: .callout .note\} Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{gmock_cook_book.md\#NewMatchers}{\texttt{ a custom G\+Mock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md37}{}\doxysubsection{Adding Traces to Assertions}\label{md_build_googletest-src_docs_advanced_autotoc_md37}
...
\end{DoxyEnumerate}\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md38}{}\doxysubsection{Propagating Fatal Failures}\label{md_build_googletest-src_docs_advanced_autotoc_md38}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md40}{}\doxysubsubsection{Asserting on Subroutines}\label{md_build_googletest-src_docs_advanced_autotoc_md40}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md41}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_build_googletest-src_docs_advanced_autotoc_md41}
...
If {\ttfamily Has\+Fatal\+Failure()} is used outside of {\ttfamily \mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{T\+E\+S\+T()}}} , {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{T\+E\+S\+T\+\_\+\+F()}}} , or a test fixture, you must add the {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}\+:\+:} prefix, as in\+:
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md42}{}\doxysection{Logging Additional Information}\label{md_build_googletest-src_docs_advanced_autotoc_md42}
...
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md43}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_build_googletest-src_docs_advanced_autotoc_md43}
...
\{\+: .callout .note\} N\+O\+TE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily T\+E\+S\+T\+\_\+P}.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md44}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_build_googletest-src_docs_advanced_autotoc_md44}
...
Now, when {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}} is called, it first calls the {\ttfamily Set\+Up()} method of each environment object, then runs the tests if none of the environments reported fatal failures and {\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}}} was not called. {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}} always calls {\ttfamily Tear\+Down()} with each environment object, regardless of whether or not the tests were run.
...
\end{DoxyItemize}\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md46}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md46}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{https://github.com/google/googletest/blob/main/googletest/samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md47}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md47}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily \mbox{\hyperlink{gtest-param-test_8h_a6a5cb3ce0a0fe17f84f357a6f39a4ba5}{I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+S\+U\+I\+T\+E\+\_\+\+P()}}}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md48}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_build_googletest-src_docs_advanced_autotoc_md48}
...
\DoxyCodeLine{    \});}
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md49}{}\doxysection{Typed Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md49}
...
Then, use {\ttfamily \mbox{\hyperlink{gtest-typed-test_8h_ae6f575265873190de41b1329d16df0f0}{T\+Y\+P\+E\+D\+\_\+\+T\+E\+S\+T()}}} instead of {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{T\+E\+S\+T\+\_\+\+F()}}} to define a typed test for this test suite. You can repeat this as many times as you want\+:
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md50}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md50}
...
Then, use {\ttfamily \mbox{\hyperlink{gtest-typed-test_8h_a6e9d1cd9b97da0076ae699775d3222d0}{T\+Y\+P\+E\+D\+\_\+\+T\+E\+S\+T\+\_\+\+P()}}} to define a type-\/parameterized test. You can repeat this as many times as you want\+:
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md51}{}\doxysection{Testing Private Code}\label{md_build_googletest-src_docs_advanced_autotoc_md51}
...
\`{}\`{}\`{}c++ \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T(\+Test\+Suite\+Name, Test\+Name)}}; \`{}\`{}\`{}

For example,

\`{}\`{}\`{}c++ // foo.\+h class Foo \{ ... private\+: \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T(\+Foo\+Test, Bar\+Returns\+Zero\+On\+Null)}};

int Bar(void$\ast$ x); \};

// foo\+\_\+test.\+cc ... \mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{T\+E\+S\+T(\+Foo\+Test, Bar\+Returns\+Zero\+On\+Null)}} \{ Foo foo; E\+X\+P\+E\+C\+T\+\_\+\+EQ(foo.\+Bar(\+N\+U\+L\+L), 0); // Uses Foo\textquotesingle{}s private member Bar(). \} \`{}\`{}\`{}
...
\} // namespace \mbox{\hyperlink{namespacemy__namespace}{my\+\_\+namespace}} \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md52}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_build_googletest-src_docs_advanced_autotoc_md52}
...
\end{DoxyEnumerate}\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md53}{}\doxysection{Registering tests programmatically}\label{md_build_googletest-src_docs_advanced_autotoc_md53}
The {\ttfamily T\+E\+ST} macros handle the vast majority of all use cases, but there are few where runtime registration logic is required. For those cases, the framework provides the {\ttfamily \mbox{\hyperlink{namespacetesting_a302c84bdc88f2138696da2a4756b6466}{testing\+::\+Register\+Test}}} that allows callers to register arbitrary tests dynamically.
...
Must be called before {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}} is invoked, otherwise behavior is undefined.
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md54}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_build_googletest-src_docs_advanced_autotoc_md54}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md55}{}\doxysection{Extending googletest by Handling Test Events}\label{md_build_googletest-src_docs_advanced_autotoc_md55}
googletest provides an {\bfseries{event listener A\+PI}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this A\+PI to augment or replace the standard console output, replace the X\+ML output, or provide a completely different form of output, such as a G\+UI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md56}{}\doxysubsection{Defining Event Listeners}\label{md_build_googletest-src_docs_advanced_autotoc_md56}
...
\DoxyCodeLine{ \};}
\end{DoxyCode}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md57}{}\doxysubsection{Using Event Listeners}\label{md_build_googletest-src_docs_advanced_autotoc_md57}
To use the event listener you have defined, add an instance of it to the googletest event listener list (represented by class \href{reference/testing.md\#TestEventListeners}{\texttt{ {\ttfamily Test\+Event\+Listeners}}} -\/ note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily \mbox{\hyperlink{build_2CMakeFiles_23_816_83_2CompilerIdC_2CMakeCCompilerId_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} function, before calling {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}}\+:
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md58}{}\doxysubsection{Generating Failures in Listeners}\label{md_build_googletest-src_docs_advanced_autotoc_md58}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md60}{}\doxysubsection{Selecting Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md60}
\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md61}{}\doxysubsubsection{Listing Test Names}\label{md_build_googletest-src_docs_advanced_autotoc_md61}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md62}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md62}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md63}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_build_googletest-src_docs_advanced_autotoc_md63}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md64}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md64}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md65}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md65}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md66}{}\doxysubsection{Repeating the Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md66}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md67}{}\doxysubsection{Shuffling the Tests}\label{md_build_googletest-src_docs_advanced_autotoc_md67}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md68}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_build_googletest-src_docs_advanced_autotoc_md68}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md69}{}\doxysubsection{Controlling Test Output}\label{md_build_googletest-src_docs_advanced_autotoc_md69}
{\itshape  }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md70}{}\doxysubsubsection{Colored Terminal Output}\label{md_build_googletest-src_docs_advanced_autotoc_md70}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md71}{}\doxysubsubsection{Suppressing test passes}\label{md_build_googletest-src_docs_advanced_autotoc_md71}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md72}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_build_googletest-src_docs_advanced_autotoc_md72}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md73}{}\doxysubsubsection{Suppressing U\+T\+F-\/8 Text Output}\label{md_build_googletest-src_docs_advanced_autotoc_md73}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md74}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_build_googletest-src_docs_advanced_autotoc_md74}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md75}{}\doxysubsubsection{Generating a J\+S\+O\+N Report}\label{md_build_googletest-src_docs_advanced_autotoc_md75}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md76}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_build_googletest-src_docs_advanced_autotoc_md76}
{\itshape  }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md77}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_build_googletest-src_docs_advanced_autotoc_md77}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md78}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_build_googletest-src_docs_advanced_autotoc_md78}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md79}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_build_googletest-src_docs_advanced_autotoc_md79}
...
{\itshape }\hypertarget{md_build_googletest-src_docs_advanced_autotoc_md80}{}\doxysubsection{Sanitizer Integration}\label{md_build_googletest-src_docs_advanced_autotoc_md80}
